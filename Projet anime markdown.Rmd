...
- **id_genres**: L'identifiant du genre de l'animé
- **id_type**: L'identifiant du type de l'animé.

Notre problématique pour le projet est : 

- Quels sont les types et les genres des animés qui ont le plus de succès ?
...
Le type film et OVA viennent après avec un pourcentage de 19.3%.
...
Pour faire ce graphique, la principale fonction utilisée est le ggplot qui nous a permis donc de faire ce graphique.
...
##Tableau de bord
Le tableau de bord réalisée




#Réponse de la problématique
Pour répondre à notre problématique, les animés qui ont le plus de succès sont ceux de type film et TV dont le genre est drama, action et comedie.<br/>
